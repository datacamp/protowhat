    ...
    def state_dec(f):
        ...
        def wrapper(*args, **kwargs):
            ...
            if isinstance(state, State):
                return link_to_state(f)(*args, **kwargs)
            else:
                return LazyChain(
...
def create_sct_context(sct_dict, root_state=None):
    """
...
def create_embed_context(context: EagerChain, technology: str, **kwargs):
    ...
    return create_sct_context(xwhat.sct_syntax.sct_dict, root_state=embedded_state)
